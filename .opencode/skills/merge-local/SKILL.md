---
name: merge-local
description: "Squash-merge feature commits into local dev, pull remote dev, and resolve conflicts"
---
...
1. Pull latest remote dev: `git fetch origin dev && git merge --ff-only origin/dev` into local dev.
