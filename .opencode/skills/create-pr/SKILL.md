---
name: create-pr
description: "Push local dev to remote dev branch for stakeholder review"
---
...
2. Create a pull request from `dev` to `main` with the squashed commit format from [[software-craft/git-conventions#content]], including @id traceability for all acceptance criteria.
